...
class _PeriodPickerSheetState extends State<PeriodPickerSheet> {
  ...
  void initState() {
    ...
    yearController = FixedExtentScrollController(initialItem: years.indexOf(year));
              ...
              SizedBox(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    const Expanded(child: Center(child: Text('请选择时间', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)))),
                    TextButton(
                      onPressed: () => Navigator.pop(context, (year: year, month: month, day: month == null ? null : day)),
                      child: const Text('确定'),
                    ),
                  ],
                ),
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: _picker<int?>(
                        ...
                        values: months,
                        label: (value) => value == null ? '不选' : '${value.toString().padLeft(2, '0')}月',
                        onSelected: (value) {
                          setState(() {
                            month = value;
                    ...
                    Expanded(
                      child: _picker<int?>(
                        ...
                        values: days,
                        label: (value) => value == null ? '不选' : '${value.toString().padLeft(2, '0')}日',
